...
public class StaticModuleParser extends ModuleParser {
	...
	/**
	 * Gets a list of all statically loaded modules. 
	 * These modules can never change so it is recommended that the result of this function be cached whenever possible.
	 * 
